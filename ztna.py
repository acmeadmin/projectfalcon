...
def listprivapps (args):
  ...
  count = 0
  while count < countingz:
    Private_Name = json_data_privapps['data']['private_apps'][count]['name']
    ...
    for i in (Publisherlist):
      if json_data_publishers['data']['publishers'][count2]['id'] in Publisherlist:
          Publisherlistname.append (json_data_publishers['data']['publishers'][count2]['name'])
          count2 += 1
...
def listpublisher (args):
  ...
  while count < counting:
    Publisher_Name = getreponse_json['data']['publishers'][count]['name']
...
def listprivappslite (args):
  ...
  while count < countingz:
    host = json_data_privapps['data']['private_apps'][count]['host']
    ID = json_data_privapps['data']['private_apps'][count]['id']
    PublisherDNS = json_data_privapps['data']['private_apps'][count]['use_publisher_dns']
